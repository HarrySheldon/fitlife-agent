...
- [ ] **Step 1: Write failing formula and safety tests**
...
- [ ] **Step 3: Implement immutable domain values and calculator**
...
- [ ] **Step 3: Implement the port and SQLite adapter**
...
- [ ] **Step 4: Run repository plus schema tests**
...
- [ ] **Step 3: Implement use cases and optimistic preview token**
...
- [ ] **Step 3: Implement API schemas, dependency factory and router**
...
- [ ] **Step 4: Run API and legacy regressions**
...
- [ ] **Step 3: Add focused types, API methods and hook**
...
- [ ] **Step 3: Implement one full-page multi-step workflow**
...
- [ ] **Step 1: Write failing decoupled editing tests**
...
- [ ] **Step 3: Split the existing form by responsibility**
...
- [ ] **Step 4: Run frontend regressions and build**
...
- [ ] **Step 1: Document the versioned target workflow**
...
- [ ] **Step 3: Validate Docker upgrade and onboarding**
...
- [ ] **Step 4: Mark Phase 2 complete only after evidence passes**
