...
def add_agent_entry(request: AgentEntryRequest, user: AuthenticatedUser | None = Depends(optional_current_user)):
    return ok(create_agent_entry(request, _user_id(user)).model_dump(), "Entry parsed")
